...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('HRApp', '0004_alter_bank_employee'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leavetype', models.CharField(choices=[('sick', 'Sick Leave'), ('anual', 'Anual Leave'), ('emergency', 'Emergency Leave'), ('study', 'Study Leave')], default='sick', max_length=25, null=True)),
